...
public class FillColourPicker extends ColourPicker {

    private static FillColourPicker pickedColour = null;

    public FillColourPicker(ColourButton colourButton, Color colour) {
